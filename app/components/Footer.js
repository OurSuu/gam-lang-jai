    ...
    <footer id="contact" className="bg-[#8B1A2B] text-white relative pt-12 pb-6 border-t-8 border-white/20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 pb-8 border-b border-white/15 items-center">
          {/* Logos in White Box */}
          <div className="bg-white rounded-3xl p-6 flex items-center justify-center gap-6 shadow-lg max-w-sm mx-auto lg:mx-0">
            <Image
          ...
          {/* New Contact Info */}
          <div className="flex flex-col sm:flex-row flex-wrap gap-x-12 gap-y-6 justify-center lg:justify-end items-center lg:items-start text-base font-medium">
            {/* Column 1 */}
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4 hover:text-white/80 transition-colors cursor-pointer">
                ...
                <span>balloonarttthai@gmail.com</span>
              </div>
